package com.xevrae.data.mapping

import com.xevrae.data.parser.toListThumbnail
...
internal fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                com.xevrae.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            com.xevrae.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
internal fun SearchSuggestions.toDomainSearchSuggestions(): com.xevrae.domain.data.model.searchResult.SearchSuggestions =
    com.xevrae.domain.data.model.searchResult.SearchSuggestions(
...
internal fun AccountInfo.toDomainAccountInfo(): com.xevrae.domain.data.model.account.AccountInfo =
    com.xevrae.domain.data.model.account.AccountInfo(
        name = this.name,
        email = this.email,
        pageId = this.pageId,
